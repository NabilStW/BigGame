		...
		try {
			...
			while (true) {
				...
				case 0 : if (game.Obstacle(this.getPosX()+1,this.getPosY())==false) {
					game.bouledefeu(this.getPosX(),this.getPosY(),direction);this.move(1,0); this.rotate(1, 0);  break;
					// game.bouledefeu(this.getPosX(),this.getPosY(),direction,1);
				}
				case 1 : if (game.Obstacle(this.getPosX(),this.getPosY()-1)==false) {
					game.bouledefeu(this.getPosX(),this.getPosY(),direction);this.move(0,-1); this.rotate(0, -1);  break;
				}
